...
namespace distortion::noise {
    OpenSimplex2S::OpenSimplex2S() {
        this->description.type = "opensimplex2S";
        this->description.category = "Noise";
        this->description.name = "OpenSimplex2S";
        ...
        this->description.tooltip = "OpenSimplex2S variant";
        this->description.arguments = offsetMinMaxArguments();
    }
    Distortion* OpenSimplex2S::cloneFromDescription(
      DistortionDescription description) const {
        auto* clone = new OpenSimplex2S(*this);
        clone->offsetMin =
    ...
    QString OpenSimplex2S::stringOfInternalValues() const {
        return QString("offsetMin: %0; offsetMax: %1")
          .arg(this->offsetMin)
          .arg(this->offsetMax);
    }
    void OpenSimplex2S::distort(cv::Mat& image) const {
